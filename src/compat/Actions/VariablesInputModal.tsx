// SOURCE: https://github.com/grafana/grafana/blob/v13.1.1/packages/grafana-ui/src/components/Actions/VariablesInputModal.tsx
...
import { useStyles2, Button, Field, FieldSet, Input, Modal } from '@grafana/ui';
