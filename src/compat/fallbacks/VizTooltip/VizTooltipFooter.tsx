// SOURCE: https://github.com/grafana/grafana/blob/v13.1.1/packages/grafana-ui/src/components/VizTooltip/VizTooltipFooter.tsx
// Fallback for hosts without the public export. See src/compat/README.md.
// Upstream code copied as-is; the quotes are part of the <Trans> default text.
...
import { useStyles2, Button, DataLinkButton, Icon, Stack } from '@grafana/ui';
import { ActionButton } from '../Actions/ActionButton';
// Inlined from @grafana/ui Table/TableNG/types, which is not exported; StackGap replaces
// the unexported ResponsiveProp<ThemeSpacingTokens>.
type StackGap = React.ComponentProps<typeof Stack>['gap'];
type AdHocFilterItem = { key: string; value: string; operator: '=' | '!=' };
