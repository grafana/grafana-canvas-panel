// SOURCE: https://github.com/grafana/grafana/blob/main/public/app/features/dimensions/utils.ts
import { type DataFrame, type PanelData, type Field, getFieldDisplayName, ReducerID } from '@grafana/data';
